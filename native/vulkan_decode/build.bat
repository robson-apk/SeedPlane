...
for %%s in (embed rope_kv attn attn_part attn_combine argmax nll embed_b rmsnorm_b gemm_b swiglu_b rope_b attn_part_b sample_stats sample_hist sample_collect sample_gumbel) do (
