...
| G3 validation | 0 errors with `VK_LAYER_KHRONOS_validation` | 0 errors (layer from the LunarG 1.4.357.1 SDK tarball, no root) | **pass** |
...
| G9 memory | VRAM after run 3 ≤ 1.05 × after run 1 | 991.1 MiB both (988 samples) | **pass** |
